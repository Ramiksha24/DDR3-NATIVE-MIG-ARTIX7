...
HD_PWD='D:/Kaynes/DDR3/DDR3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_native_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr3_native_top.tcl
