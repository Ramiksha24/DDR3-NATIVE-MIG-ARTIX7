...
HD_PWD='D:/Kaynes/DDR3/DDR3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_native_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ddr3_native_top.tcl -notrace
